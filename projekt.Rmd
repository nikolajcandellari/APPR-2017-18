...
```{r, echo=FALSE}
bind_cols(pozari=top5("POŽARI IN EKSPLOZIJE"), prometne=top5("NESREČE V PROMETU"), tehnicne=top5("TEHNIČNA IN DRUGA POMOČ"), druge=top5("DRUGE NESREČE"), naravne=top5("NARAVNE NESREČE"))
```
